# AGENTS.md — Agent Configuration for Event Log API Code Review
...
2. Confirm baseline: run test suite.
...
## Project Map (fill in as you learn)
- FastAPI entrypoint: `app/main.py` (lifespan/init, router mounting)
...
> Update this section with any additional modules discovered.
...
- Avoid mixing `HTTPException` default format with custom error format.
- Keep error payload shape consistent across endpoints.

## Timestamp Rules
- Treat incoming timestamps as ISO 8601.
...
When asked to “implement”, keep commits small and ensure:
- All tests pass
